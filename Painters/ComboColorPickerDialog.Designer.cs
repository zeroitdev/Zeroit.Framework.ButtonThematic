...
namespace Zeroit.Framework.ButtonThematic.Editors
{
    partial class ComboColorPickerDialog
    {
        ...
        {
            this.comboColorPicker = new Zeroit.Framework.ButtonThematic.Editors.ComboColorPicker();
            this.SuspendLayout();
            // 
            // comboColorPicker
            // 
            ...
            this.comboColorPicker.ColorSelected += new Zeroit.Framework.ButtonThematic.Editors.BaseColorPicker.ColorSelectedEventHandler(this.comboColorPicker_ColorSelected);
            // 
