...
namespace Zeroit.Framework.ButtonThematic.Editors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            Zeroit.Framework.ButtonThematic.Editors.ComboColorPickerDialog d = new Zeroit.Framework.ButtonThematic.Editors.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
