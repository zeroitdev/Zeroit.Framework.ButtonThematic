...
namespace Zeroit.Framework.ButtonThematic.Controls
{
    ...
    public partial class ButtonThematic
    {
        ...
        {
            get { return buttonInput.CustomExcisionStyle; }
            set
            {
                buttonInput.CustomExcisionStyle = value;
                Invalidate();
            }
        }
        ...
        {
            get { return buttonInput.ImageCodeString; }
            set
            {
                buttonInput.ImageCodeString = value;
                Invalidate();
            }
        }
        ...
        {
            get { return buttonInput.CustomExcisionBorderColors; }
            set {
                buttonInput.CustomExcisionBorderColors = value;
                Invalidate();
            }
        }
