...
namespace Zeroit.Framework.ButtonThematic.Controls
{
    ...
    public partial class ButtonThematic
    {
        ...
        public void UnClearbutton()
        {
            IsAnimated = true;
            
        }
        Color G1 = Color.FromArgb(40,40,40);
        Color G2 = Color.FromArgb(45,45,45);
        Color Glow = Color.FromArgb(50,50,50);
        Color Edge = Color.FromArgb(60, 60, 60);
        Color TextColor = Color.FromArgb(255, Color.White);
        Color Hovercolor = Color.FromArgb(10, 10, 10);

        int uClearA = 0;
        

        private void UClearOnAnimation()
        {
            switch (State)
            {
        ...
        private void UClearPaintHook()
        {
            ...
            {
                SolidBrush SB = new SolidBrush(Color.FromArgb(uClearA * 2, Color.FromArgb(30, 30, 30)));
